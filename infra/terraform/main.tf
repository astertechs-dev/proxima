terraform {
  ...
  backend "s3" {
    ...
    # bucket = "proxima-terraform-state"
...
# Local values
locals {
  name_prefix = "proxima-${var.environment}"
...
resource "aws_s3_bucket" "files" {
  bucket = "${local.name_prefix}-files-${random_string.bucket_suffix.result}"
